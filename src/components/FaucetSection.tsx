...
export default function FaucetSection({ }) {
  ...
  return (
    <section className="mx-auto max-w-lg space-y-3">
      <div>
        <p>Add free MATIC to your wallet using Polygon testnet.</p>
        <p className="text-sm text-gray-500">
          *You will need to authorized via discord for using Polygon testnet
        </p>
      </div>

      <div className="justify-between space-y-2 md:flex md:space-x-4 md:space-y-0">
        <button
          className={`${copyState.copied ? "text-[#00875F]" : ""
