        ...
        <div className="details">
          <div className="top">
            ...
            <div className="content">
              <div className="button">
                <a href="./index2" className="btn">
                  video
                </a>
                <a href="./index3" className="btn">
                  Art
                </a>
              </div>
              <div className=" content-details">
                ...
                <div className=" content-details" id="singleSong">
                  <div className="overview" style={{ marginTop: "10%" }}>
                    ...
                    <h1>
                      We need to fill the space that stays blank untill an user
                      selects an album
                    </h1>
                    <h1>
                      This space can be used to present the way the project workss
                    </h1>
                  </div>
                </div>
              </div>
